...
/**
 *
 * OutputLayer This class represents an output layer of a neural network,
 * inheriting from NeuralLayer, which contains all basic definitions of a Neural
 * Layer
 * 
...
public class OutputLayer extends NeuralLayer {
	...
	public OutputLayer(NeuralNet _neuralNet, int numberofneurons, IActivationFunction iaf, NeuralLayer _previousLayer) {
		super(_neuralNet, numberofneurons, iaf);
	...
	/**
	 * setNextLayer This method prevents any attempt to link this layer to a next
	 * one, provided that this should be always the last
	 * 
	...
	/**
	 * setPreviousLayer This method links this layer to the previous one
	 * 
