...
package ai.neural.init;

import ai.neural.math.RandomNumberGenerator;

/**
 * This class extends WeightInitialization class and it uses values produced by
 * Guassian distribution to initialize neural net weights
 * 
...
public class GaussianInitialization extends WeightInitialization {
	...
	/**
	 * Generates random numbers taking into account Gaussian parameters (mean and
	 * stdev)
	 * 
