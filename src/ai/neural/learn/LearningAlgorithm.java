...
import ai.neural.data.DataNormalization;
...
public abstract class LearningAlgorithm {
	...
	public void setFittingEvolution(DataSet _dataset, NeuralDataSet _fittingEvolution, int _outputColumn,
			int[] _filterColumns, double[][] _filters) {
