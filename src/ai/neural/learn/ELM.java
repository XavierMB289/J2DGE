...
public class ELM extends DeltaRule {
	...
	public void train() throws NeuralException {
		if (neuralNet.getNumberOfHiddenLayers() != 1)
			throw new NeuralException(
					"The ELM learning algorithm can be performed only on Single Hidden Layer Neural Network");
	...
	public void forward(int i) throws NeuralException {
		if (neuralNet.getNumberOfHiddenLayers() != 1) {
			throw new NeuralException("ELM can be used only with single" + " hidden layer neural network");
		}
