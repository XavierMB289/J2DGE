...
import ai.neural.math.IdentityMatrix;
...
public class LevenbergMarquardt extends Backpropagation {
	...
	public LevenbergMarquardt(NeuralNet _neuralNet, NeuralDataSet _trainDataSet, DeltaRule.LearningMode _learningMode) {
	...
	public double generalError(int k) {
		return generalError(trainingDataSet.getArrayTargetOutputRecord(k),
