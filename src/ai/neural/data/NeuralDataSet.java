...
public class NeuralDataSet {
	...
	public double[][] getTargetVsEstimated(int output) {
		return ArrayOperations.transposeMatrix(
				new double[][] { outputData.getTargetColumn(output), outputData.getNeuralColumn(output) });
	}
	...
	public static NeuralDataSet[] randomSeparateTrainTest(DataSet ds, int[] inputColumns, int[] outputColumns,
			double percTrain) {
