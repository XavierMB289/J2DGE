...
package ai.neural.math;

import java.util.ArrayList;

/**
 * 
 * This class has static functions that are used to make array operations, i.e.,
 * get max and min value of an array, calculate average and std dev of an array,
 * etc
 * 
