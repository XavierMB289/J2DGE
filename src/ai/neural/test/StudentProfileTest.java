...
/**
 *
 * StudentProfileTest This class performs test of Neural Net using profile
 * student data, Levenberg Marquardt algorithm, and ELM algorithm
 * 
...
public class StudentProfileTest {
	public static void main(String[] args) {
		...
		double[][] _neuralDataSet = { { 1.0, 0.73, 1.0, -1.0 }, { 1.0, 0.81, 1.0, -1.0 }, { 1.0, 0.86, 1.0, -1.0 },
				{ 0.0, 0.65, 1.0, -1.0 }, { 0.0, 0.45, 1.0, -1.0 }, { 1.0, 0.70, -1.0, 1.0 }, { 0.0, 0.51, -1.0, 1.0 },
				{ 1.0, 0.89, -1.0, 1.0 }, { 1.0, 0.79, -1.0, 1.0 }, { 0.0, 0.54, -1.0, 1.0 }
		...
		NeuralNet nnlm = new NeuralNet(numberOfInputs, numberOfOutputs, numberOfHiddenNeurons, hiddenAcFnc,
				outputAcFnc);

		NeuralNet nnelm = new NeuralNet(numberOfInputs, numberOfOutputs, numberOfHiddenNeurons, hiddenAcFnc,
				outputAcFnc);
