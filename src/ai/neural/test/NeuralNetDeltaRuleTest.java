...
import ai.neural.math.HyperTan;
import ai.neural.math.Linear;
import ai.neural.math.RandomNumberGenerator;

/**
 *
 * NeuralNetDeltaRuleTest This class solely performs test of Neural Net using
 * Delta Rule
 * 
...
public class NeuralNetDeltaRuleTest {
	...
	public static void main(String[] args) {
		...
		double[][] _neuralDataSet = { { 1.2, fncTest(1.2) }, { 0.3, fncTest(0.3) }, { -0.5, fncTest(-0.5) },
				{ -2.3, fncTest(-2.3) }, { 1.7, fncTest(1.7) }, { -0.1, fncTest(-0.1) }, { -2.7, fncTest(-2.7) } };
		...
		try {
			...
			double[][] _testDataSet = { { -1.7, fncTest(-1.7) }, { -1.0, fncTest(-1.0) }, { 0.0, fncTest(0.0) },
					{ 0.8, fncTest(0.8) }, { 2.0, fncTest(2.0) } };
