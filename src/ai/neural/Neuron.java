...
/**
 *
 * Neuron This class represents the artificial Neuron, the most basic unit in a
 * neural network. It encapsulates all attributes and properties related to a
 * neuron, including weights, inputs, output, activation function, calculation.
...
public class Neuron {
	...
	/**
	 * setInputs Sets a vector of double-precision values to the neuron input
	 * 
	...
	/**
	 * setInputs Sets an array of values to the neuron's input
	 * 
	 * @param values
	 */
	...
	/**
	 * setInput Sets a real value at the ith java position of the neuron's inputs
	 * 
	...
	/**
	 * updateWeight Method used for updating the weight during learning
	 * 
	...
	/**
	 * setWeight sets the weight at the ith java position
	 * 
	...
	/**
	 * calc Calculates the neuron's output
	 */
	public void calc() {
	...
	/**
	 * setActivationFunction Sets the activation function of this neuron
	 * 
	 * @param iaf Activation function
	 */
