...
/**
 * 
 * NeuralLayer This is an abstract class for any Neural Layer. All general
 * attributes and behaviors intrinsic to a layer of neuron are defined in this
 * class.
 * 
...
public abstract class NeuralLayer {
	...
	/**
	 * init Initializes the Neural Layer by setting the activation function for all
	...
	/**
	 * setInputs Sets an array of real values to this layer's input
	 * 
	...
	/**
	 * calc Calculates the outputs of all neurons of this layer
	 */
	protected void calc() {
	...
	/**
	 * setNeuron Sets an already created Neuron at this layer's input
	 * 
